 ...
 */
public class Form6_LocationNeck_Early extends javax.swing.JFrame {
    ...
    public void CheckEmpty(){
        if (!RadioBox1.isSelected()&&!RadioBox2.isSelected()&&!RadioBox3.isSelected()&&!RadioBox4.isSelected()) {
            JOptionPane.showMessageDialog(this, "Langkah 6 Tidak Boleh Kosong\nAtau Coba Pilih Lagi", "Pesan", JOptionPane.ERROR_MESSAGE);
        } else {
...
//            JOptionPane.showMessageDialog(this, "Langkah 1 Tidak Boleh Kosong\nAtau Coba Pilih Lagi", "Pesan", JOptionPane.ERROR_MESSAGE);
    ...
    public void Insertlocation_neck() {
        try {
            ...
            String simpan = "UPDATE t_rula SET location_neck ='" + Slocation_neck + "' WHERE nim='" + Form02_Profile_Early.TFNIM.getText()+"'";
    ...
    public void ImageSize() {
        ...
        ImageIcon ii2 = new ImageIcon(getClass().getResource("/Iamges_Early/neck6.jpg"));
    ...
    public void CheckNext() {
        try{
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()){
                String UpperArm = res.getString("location_neck");
                if (UpperArm.equals("")) {
    ...
    public Form6_LocationNeck_Early() {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelLangkah6.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        LabelLangkah6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LabelLangkah6.setText("Langkah 6: Temukan Posisi Leher");
        jPanel1.add(LabelLangkah6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 66, 1022, -1));

        Gambar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck1.jpg"))); // NOI18N
        jPanel1.add(Gambar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, -1, -1));

        Gambar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck2.jpg"))); // NOI18N
        jPanel1.add(Gambar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, -1, -1));

        Gambar3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck3.jpg"))); // NOI18N
        jPanel1.add(Gambar3, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, -1, -1));

        Gambar4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck4.jpg"))); // NOI18N
        jPanel1.add(Gambar4, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 130, -1, -1));
        ...
        LabelLangkah6a.setText("Langkah 6a: Centang juga kotak-kotak berikut ini jika sesuai");
        jPanel1.add(LabelLangkah6a, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 445, 1022, -1));
        ...
        Gambar5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck5.jpg"))); // NOI18N
        ...
        CheckBox1.setText("Jika leher terpelintir");
        ...
        jPanel1.add(CheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 550, 160, -1));
        ...
        Gambar6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iamges_Early/neck6.jpg"))); // NOI18N
        ...
        CheckBox2.setText("Jika leher terpelintir");
        ...
        jPanel1.add(CheckBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 540, 160, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form6_LocationNeck_Early.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
