 ...
 */
public class Form9_NeckTrunkLegs_MuscleUse_Early extends javax.swing.JFrame {
...
//            JOptionPane.showMessageDialog(this, "Langkah 1 Tidak Boleh Kosong\nAtau Coba Pilih Lagi", "Pesan", JOptionPane.ERROR_MESSAGE);
    ...
    public void Insertnecktrunklegs_muscle() {
        try {
            ...
            String simpan = "UPDATE t_rula SET necktrunklegs_muscle ='" + Snecktrunklegs_muscle + "' WHERE nim='" + Form02_Profile_Early.TFNIM.getText()+"'";
    ...
    public void CheckNext() {
        try{
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()){
                String UpperArm = res.getString("necktrunklegs_muscle");
                if (UpperArm.equals("")) {
    ...
    public Form9_NeckTrunkLegs_MuscleUse_Early() {
        initComponents();
    ...
    private void initComponents() {
        ...
        LabelLangkah9.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        LabelLangkah9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        LabelLangkah9.setText("Langkah 9: Pilih gaya dan beban yang paling mencerminkan situasi kerja");
        jPanel1.add(LabelLangkah9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 66, 1022, -1));
        ...
        LabelLangkah9a.setText("Langkah 9a: Pilih kotak ini jika mencerminkan penggunaan otot Anda");
        jPanel1.add(LabelLangkah9a, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 450, 1022, -1));
        ...
        LabelCheckBox1.setText("Atau jika tindakan yang diulang terjadi 4X per menit");
        jPanel1.add(LabelCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(332, 514, 360, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form9_NeckTrunkLegs_MuscleUse_Early.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
